...
// Function to escape special characters for form submission
function escapeForForm(str) {
    return str.replace(/'/g, "\\'");
}

// Function to unescape form values
function unescapeForm(str) {
    return str.replace(/\\'/g, "'");
}

// Function to handle special characters in country names
